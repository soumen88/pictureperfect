...
abstract class $MovieModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int page, List<ResultsModel> results});
}
...
class _$MovieModelImpl implements _MovieModel {
  const _$MovieModelImpl(
      {required this.page, required final List<ResultsModel> results})
      : _results = results;
...
abstract class _MovieModel implements MovieModel {
  const factory _MovieModel(
      ...
      required final List<ResultsModel> results}) = _$MovieModelImpl;
